...
public class View {
	...
	public String changeBoatType(){
		...
		return boatTypeChange;
	}

	public String changeBoatLength(){
	...
	public String searchSecurityNumber() {
		System.out.print("Security number: ");
		String searchSecurityNr= scanner.next(); 
		return searchSecurityNr;
	}
	
	public String searchBoatType() {
		System.out.print("Boat type: ");
		String searchBoatType = scanner.next(); 
		return searchBoatType;
	}
}
